...
``.safetensors`` checkpoint, with :func:`validate_safetensors` as the cheap
check the download half runs to reject a transfer that was cut short.
...
.. autofunction:: validate_safetensors
