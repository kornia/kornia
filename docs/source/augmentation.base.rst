...
The ``kornia.augmentation.auto`` policies containing operation wrappers cannot be pickled
(`#4469 <https://github.com/kornia/kornia/issues/4469>`_); an empty ``AutoAugment(policy=[[]])`` can.
