...
- transforms: The module provides low level interfaces to manipulate 2D images, with routines for Rotating,
  ...
  Functions to warp tensorsgiven affine or perspective transformations,
...
:Resources:
   ...
   **align_corners**
   ...
   - align_corners=True, pixels are regarded as a grid of points. Points at the corners are aligned.
   - align_corners=False, pixels are regarded as 1x1 areas. Area boundaries, rather than their centers, are aligned.
