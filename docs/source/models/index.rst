...
pretrained weights that are downloaded on first use; ViT and MobileViT ship as architectures only, for training or
for loading your own checkpoint. Each page below opens with the shortest script that runs the model, shows what it
