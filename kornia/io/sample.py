...
def get_sample_images(
    ...
    **kwargs: Any,
    ...
    Removed from ``kornia.utils.sample`` in 0.8.3 and restored here as public API — the docs and downstream
    demos rely on it.
    ...
    """
    import kornia.geometry  # local import to avoid a circular dependency at import time
