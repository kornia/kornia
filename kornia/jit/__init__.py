...
spatial_softmax2d = torch.jit.script(K.geometry.subpix.dsnt.spatial_softmax2d)
spatial_expectation2d = torch.jit.script(K.geometry.subpix.dsnt.spatial_expectation2d)
render_gaussian2d = torch.jit.script(K.geometry.subpix.dsnt.render_gaussian2d)
