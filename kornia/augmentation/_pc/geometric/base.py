...
class GeometricAugmentationBasePC(RigidAffineAugmentationBasePC):
    r"""GeometricAugmentationBasePC base class for customized geometric augmentation implementations.
