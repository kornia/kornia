...
class RandomPerspective(AugmentationBase2D):
    ...
    def __init__(
        ...
        self.align_corners: Optional[bool] = _parse_align_corners(align_corners, self.resample, old_default=False)
...
class CenterCrop(AugmentationBase2D):
    ...
    def __init__(self, size: Union[int, Tuple[int, int]], align_corners: Optional[bool] = None,
        ...
        self.size = size
        self.resample = Resample.get(resample)
        self.align_corners: Optional[bool] = _parse_align_corners(align_corners, self.resample, old_default=True)
        self.flags: Dict[str, torch.Tensor] = dict(
            interpolation=torch.tensor(self.resample.value),
            align_corners=torch.tensor(self.align_corners)
        )
