...
def shear_x(min_mag: float, max_mag: float) -> OperationBase:  # noqa: D103
    if min_mag != -max_mag:
        raise ValueError(
...
def shear_y(min_mag: float, max_mag: float) -> OperationBase:  # noqa: D103
    if min_mag != -max_mag:
        raise ValueError(
...
def translate_x(min_mag: float, max_mag: float) -> OperationBase:  # noqa: D103
    if min_mag != -max_mag:
        raise ValueError(
...
def translate_y(min_mag: float, max_mag: float) -> OperationBase:  # noqa: D103
    if min_mag != -max_mag:
        raise ValueError(
...
def rotate(min_mag: float, max_mag: float) -> OperationBase:  # noqa: D103
    if min_mag != -max_mag:
        raise ValueError(
...
def auto_contrast(min_mag: float, max_mag: float) -> OperationBase:  # noqa: D103
    return AutoContrast(1.0)


def invert(min_mag: float, max_mag: float) -> OperationBase:  # noqa: D103
    return Invert(1.0)


def equalize(min_mag: float, max_mag: float) -> OperationBase:  # noqa: D103
    return Equalize(1.0)


def solarize(min_mag: float, max_mag: float) -> OperationBase:  # noqa: D103
    return Solarize(None, 1.0, magnitude_range=(min_mag, max_mag))


def solarize_add(min_mag: float, max_mag: float) -> OperationBase:  # noqa: D103
    return SolarizeAdd(None, 1.0, magnitude_range=(min_mag, max_mag))


def posterize(min_mag: float, max_mag: float) -> OperationBase:  # noqa: D103
    return Posterize(None, 1.0, magnitude_range=(min_mag, max_mag))


def contrast(min_mag: float, max_mag: float) -> OperationBase:  # noqa: D103
    return Contrast(None, 1.0, magnitude_range=(min_mag, max_mag))


def brightness(min_mag: float, max_mag: float) -> OperationBase:  # noqa: D103
    return Brightness(None, 1.0, magnitude_range=(min_mag, max_mag))


def sharpness(min_mag: float, max_mag: float) -> OperationBase:  # noqa: D103
    return Sharpness(None, 1.0, magnitude_range=(min_mag, max_mag))


def color(min_mag: float, max_mag: float) -> OperationBase:  # noqa: D103
