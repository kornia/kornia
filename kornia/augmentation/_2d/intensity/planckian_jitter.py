...
_planckian_coeffs = {'blackbody': Tensor([[0.6743, 0.4029, 0.0013],
                     ...
                     'CIED': Tensor([[0.5829, 0.4421, 0.2288],
...
class RandomPlanckianJitter(IntensityAugmentationBase2D):
    ...
    Args:
        ...
        select_from: choose a list of jitters to apply from. For `blackbody`, ranged from 0 to 24 and for `CIED`,  ranged from 0 to 22.
    ...
    def apply_transform(
        ...
        r_w = self.pl[list_idx][:, 0][..., None, None]
        b_w = self.pl[list_idx][:, 1][..., None, None]
