...
class RandomBrightness(IntensityAugmentationBase2D):
    ...
    def forward(self, *args: Any, **kwargs: Any) -> torch.Tensor:
        ...
        # "single image tensor, deterministic p" call.  The brightness factor
        ...
        if (
            ...
            if d == 4:
                ...
                brightness_factor = params["brightness_factor"].to(x)
                return adjust_brightness(x, brightness_factor - 1, self.clip_output)
