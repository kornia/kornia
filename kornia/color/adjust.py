...
class AdjustBrightness(nn.Module):
    ...
    Args:
        ...
        brightness_factor (torch.Tensor): Brightness adjust factor. 0 generates
          a compleatly black image, 1 does not modify the input image while any
          other non-negative number modify the brightness by this factor.
