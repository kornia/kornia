...
- `.claude/skills/kornia-review-loop/SKILL.md` — responding to review findings on a PR: triage against the branch's merge-base (not `origin/main`, which has moved), fix defects only, delta self-review, `pixi run verify-delta`, then push once.
