...
class TestBoxBlur:
    ...
    def test_kernel_3x3(self):
        ...
        kernel_size = (3, 3)
        actual = tgm.filters.box_blur(inp, kernel_size)
    ...
    def test_gradcheck(self):
        ...
        assert gradcheck(tgm.filters.box_blur, (img, (3, 3),),
    ...
    def test_jit(self):
        ...
        def op_script(input: torch.Tensor,
            ...
            return tgm.filters.box_blur(input, kernel_size)
        kernel_size = (3, 3)
        img = torch.rand(2, 3, 4, 5)
        actual = op_script(img, kernel_size)
        expected = tgm.filters.box_blur(img, kernel_size)
