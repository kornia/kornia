...
class TestAdjustSaturation:
    def test_saturation_one(self, device):
        ...
        f = kornia.nn.enhance.AdjustSaturation(1.)
    ...
    def test_saturation_one_batch(self):
        ...
        expected = data
        f = kornia.nn.enhance.AdjustSaturation(torch.ones(2))
        assert_allclose(f(data), expected)
...
class TestAdjustHue:
    def test_hue_one(self, device):
        ...
        f = kornia.nn.enhance.AdjustHue(0.)
        assert_allclose(f(data), expected)
    ...
    def test_hue_one_batch(self):
        ...
        expected = data
        f = kornia.nn.enhance.AdjustHue(torch.tensor([0, 0]))
        assert_allclose(f(data), expected)
    ...
    def test_hue_flip_batch(self):
        ...
        f = kornia.nn.enhance.AdjustHue(torch.tensor([-pi, pi]))
        result = f(data)
...
class TestAdjustGamma:
    def test_gamma_zero(self, device):
        ...
        f = kornia.nn.enhance.AdjustGamma(0.)
        assert_allclose(f(data), expected)
    ...
    def test_gamma_one(self, device):
        ...
        f = kornia.nn.enhance.AdjustGamma(1.)
        assert_allclose(f(data), expected)
    ...
    def test_gamma_one_gain_two(self, device):
        ...
        f = kornia.nn.enhance.AdjustGamma(1., 2.)
        assert_allclose(f(data), expected)
    ...
    def test_gamma_two(self, device):
        ...
        f = kornia.nn.enhance.AdjustGamma(2.)
        assert_allclose(f(data), expected)
    ...
    def test_gamma_two_batch(self):
        ...
        f = kornia.nn.enhance.AdjustGamma(torch.tensor([2., 2.]), gain=torch.ones(2))
        assert_allclose(f(data), expected)
...
class TestAdjustContrast:
    def test_factor_zero(self, device):
        ...
        f = kornia.nn.enhance.AdjustContrast(0.)
    ...
    def test_factor_one(self, device):
        ...
        f = kornia.nn.enhance.AdjustContrast(1.)
    ...
    def test_factor_two(self, device):
        ...
        f = kornia.nn.enhance.AdjustContrast(2.)
    ...
    def test_factor_tensor(self, device):
        ...
        f = kornia.nn.enhance.AdjustContrast(factor)
        assert_allclose(f(data), expected)
...
class TestAdjustBrightness:
    def test_factor_zero(self, device):
        ...
        f = kornia.nn.enhance.AdjustBrightness(0.)
        assert_allclose(f(data), expected)
    ...
    def test_factor_one(self, device):
        ...
        f = kornia.nn.enhance.AdjustBrightness(1.)
        assert_allclose(f(data), expected)
    ...
    def test_factor_minus(self, device):
        ...
        f = kornia.nn.enhance.AdjustBrightness(-0.5)
        assert_allclose(f(data), expected)
    ...
    def test_factor_tensor(self, device):
        ...
        f = kornia.nn.enhance.AdjustBrightness(factor)
        assert_allclose(f(data), expected)
