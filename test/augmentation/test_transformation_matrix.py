...
class TestIntensityTransformation:
    ...
    def test_intensity_transformation(self):
        ...
        assert_close(F.compute_intensity_transformation(input[None]), expected_transform, atol=1e-4, rtol=1e-5)
    ...
    def test_intensity_transformation_batch(self):
        ...
        assert_close(F.compute_intensity_transformation(input), expected_transform, atol=1e-4, rtol=1e-5)
