...
class TestColorJitter:
    ...
    def test_random_hue(self):
        ...
        expected = torch.tensor([[[[0.1000, 0.2000, 0.3000],
                                  ...
                                  [[1.0000, 0.6578, 0.7000],
                                   [0.6789, 0.3000, 0.2000],
                                   [0.8000, 0.1000, 0.2000]],

                                  [[0.3634, 0.8000, 0.6948],
                                   [0.9000, 0.3526, 0.2526],
                                   [0.7737, 0.5840, 0.7103]]],


                                 [[[0.1000, 0.2000, 0.3000],
                                   [0.6726, 0.5000, 0.4000],
                                   [0.7000, 0.8000, 1.0000]],

                                  [[1.0000, 0.3547, 0.5031],
                                   [0.6000, 0.3484, 0.2484],
                                   [0.7758, 0.1000, 0.2000]],

                                  [[0.8179, 0.8000, 0.7000],
