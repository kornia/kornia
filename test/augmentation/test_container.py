...
class TestVideoSequential:
    ...
    @pytest.mark.parametrize('data_format', ["BCTHW", "BTCHW"])
    @pytest.mark.parametrize('random_apply', [2, (2, 2), (2, 3), True, False])
...
class TestSequential:
    ...
    @pytest.mark.parametrize('random_apply', [1, (2, 2), (1, 2), False])
...
class TestAugmentationSequential:
    ...
    @pytest.mark.parametrize('random_apply', [1, (2, 2), (1, 2), True, False])
