...
from kornia.nerf.colmap_parser import parse_colmap_cameras, parse_colmap_output, parse_colmap_points_3d
...
@pytest.fixture
def colmap_points_3d_path():
    return Path(__file__).parent / './points3D.txt'
