...
class TestMakeUpright:
    ...
    @staticmethod
    def test_do_nothing_with_scalea(device):
...
class TestGetCreateLAF:
    ...
    @staticmethod
    def test_cross_consistency(device):
