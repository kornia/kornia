...
class TestMedianBlur:
    def test_shape(self):
        ...
        median = tgm.image.MedianBlur((3, 3))
    ...
    def test_kernel_3x3(self):
        ...
        kernel_size = (3, 3)
        actual = tgm.image.median_blur(inp, kernel_size)
    ...
    def test_gradcheck(self):
        ...
        assert gradcheck(tgm.image.median_blur, (img, (5, 3),),
    ...
    def test_jit(self):
        ...
        def op_script(input: torch.Tensor,
            ...
            return tgm.image.median_blur(input, kernel_size)
        kernel_size = (3, 5)
        img = torch.rand(2, 3, 4, 5)
        actual = op_script(img, kernel_size)
        expected = tgm.image.median_blur(img, kernel_size)
