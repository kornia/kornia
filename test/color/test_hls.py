...
class TestRgbToHls(BaseTester):
    ...
    def test_unit(self, device, dtype):
        ...
        # OpenCV
        expected = torch.tensor([[[4.59454770, 4.26846900, 0.97384680, 2.27317070, 3.26934400],
...
class TestHlsToRgb(BaseTester):
    ...
    def test_unit(self, device, dtype):
        ...
        # OpenCV
        expected = torch.tensor([[[[0.21650219, 0.01911971, 0.91374826, 0.17609520, 0.10979544],
