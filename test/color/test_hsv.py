...
class TestRgbToHsv(BaseTester):
    ...
    def test_unit(self, device, dtype):
        ...
        # OpenCV
        expected = torch.tensor([[[1.6519808, 1.31889750, 2.24879380, 3.58221600, 2.25095400],
...
class TestHsvToRgb(BaseTester):
    ...
    def test_unit(self, device, dtype):
        ...
        # OpenCV
        expected = torch.tensor([[[[0.42132590, 0.93021995, 0.26564622, 0.58528465, 0.53384290],
