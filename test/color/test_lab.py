...
class TestRgbToLuv(BaseTester):
    ...
    def test_unit(self, device, dtype):
        ...
        expected = torch.tensor([[[58.02612517, 72.48876064, 79.75208576, 86.38913217,
                                 ...
                                 [[-12.99941502, 63.48788307, -9.49591204, 32.9931831,
                                   47.80929165],
    ...
    def test_unit(self, device, dtype):
        ...
        expected = torch.tensor([[[[0.63513142, 0., 0.10660624, 0.79048697, 0.26823414],
                                  ...
                                  [[0.94172458, 0.66390044, 0.21043296, 0.02453515, 0.04169043],
                                   ...
                                   [0., 1., 0.80867314, 1., 0.28778443]]]], device=device, dtype=dtype)

        assert_allclose(kornia.color.lab_to_rgb(data), expected)
