...
class TestRgbToLab(BaseTester):
    ...
    def test_unit(self, device, dtype):
        data = torch.tensor([
            [[0., 1., 0.69396782, 0.63581685, 0.09902618], [0.59459005, 0.74215373, 0.89662376, 0.25920381, 0.89937686],
             [0.29857584, 0.28139791, 0.16441015, 0.55507519, 0.06124221],
             [0.40908658, 0.10261389, 0.01691456, 0.76006799, 0.32971736]],
            [[0., 1., 0.79009938, 0.91742945, 0.60044175], [0.42812678, 0.18552390, 0.04186043, 0.38030245, 0.15420346],
             [0.13552373, 0.53955473, 0.79102736, 0.49050815, 0.75271446],
             [0.39861023, 0.80680277, 0.82823833, 0.54438462, 0.22063386]],
            [[0., 1., 0.84317145, 0.59529881, 0.15297393], [0.59235313, 0.36617295, 0.34600773, 0.40304737, 0.61720451],
        ...
        expected = torch.tensor([[[0., 100., 79.75208576, 86.38913217, 55.25164186],
                                 ...
                                 [[0., -0.002454937, -5.40909568, -37.74958445, -55.02172792],
                                 ...
                                 [[0., 0.00465342, -9.49591204, 32.9931831, 47.80929165],
...
class TestLabToRgb(BaseTester):
    ...
    def test_unit(self, device, dtype):
        ...
        expected = torch.tensor([[[[0.63513142, 0., 0.10660624, 0.79048697, 0.26823414],
                                   [0.48903025, 0.64529494, 0.91140099, 0.15877841, 0.45987959],
                                   [1., 0.36069696, 0.29236125, 0.55744393, 0.],
                                   [0.41710863, 0.3198324, 0., 0.94256868, 0.82748892]],
                                  [[0.28210726, 0.26080003, 0.15027717, 0.54540429, 0.80323837],
                                   [0.748392, 0.68774842, 0.24204415, 0.83695682, 0.9902132],
                                   [0., 0.79101603, 0.26633725, 0.89223337, 0.82301254],
                                   [0.84857086, 0.34455393, 0.66555314, 0.86168397, 0.8948667]],
                                  [[0.94172458, 0.66390044, 0.21043296, 0.02453515, 0.04169043],
                                   [0.28233233, 0.20235374, 0.19803933, 0.55069441, 0.
                                    ], [0.50205101, 0., 0.79745394, 0.25376936, 0.6114783],
                                   [0., 1., 0.80867314, 1., 0.28778443]]]],
                                device=device,
                                dtype=dtype)

        expected_unclipped = torch.tensor([[[[0.63513142, -1.78708635, 0.10660624, 0.79048697, 0.26823414],
                                             [0.48903025, 0.64529494, 0.91140099, 0.15877841, 0.45987959],
