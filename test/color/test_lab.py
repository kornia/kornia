...
class TestRgbToLab(BaseTester):
    ...
    def test_unit(self, device, dtype):
        ...
        expected = torch.tensor(
            [
                [
                    [0., 100., 79.75208576, 86.38913217, 55.25164186],
    ...
    def test_unit(self, device, dtype):
        ...
        expected = torch.tensor(
            [
                [
                    [
                        [0.63513142, 0., 0.10660624, 0.79048697, 0.26823414],
                    ...
                    [
                        ...
                        [0.50205101, 0., 0.79745394, 0.25376936, 0.6114783], [0., 1., 0.80867314, 1., 0.28778443]
                    ]
                ]
            ],
            device=device,
