...
_BFLOAT16_UNSUPPORTED = {"TestRgbToGrayscale", "TestBgrToGrayscale"}
...
def xfail_bfloat16_unsupported(request):
    ...
    if cls is not None and cls.__name__ in _BFLOAT16_UNSUPPORTED and dtype == torch.bfloat16:
        request.applymarker(pytest.mark.xfail(reason="bfloat16 is not supported by this function", strict=False))
