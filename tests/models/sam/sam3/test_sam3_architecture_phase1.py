...
"""Tests for SAM-3 architecture components (Phase 1)."""
...
from kornia.models.sam.sam3.architecture import ImageEncoderHiera
from kornia.models.sam.sam3.architecture.common import Attention, LayerNorm, MLPBlock, get_activation_fn
...
class TestSam3Common(BaseTester):
    ...
    def test_layer_norm_smoke(self, device: str, embed_dim: int) -> None:
        ...
        B, N = 2, 64
        ln = LayerNorm(embed_dim).to(device)
    ...
    @pytest.mark.parametrize("activation", ["relu", "gelu", "gelu_approx", "sigmoid"])
    def test_get_activation_fn(self, activation: str) -> None:
    ...
    def test_get_activation_fn_invalid(self) -> None:
