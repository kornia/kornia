...
def laplacian(
    input: IntegratedTensor, kernel_size: tuple[int, int] | int, border_type: str = 'reflect', normalized: bool = True
) -> IntegratedTensor:
    ...
    Examples:
        ...
        torch.Size([2, 4, 5, 5])
    """
    kernel = get_laplacian_kernel2d(kernel_size, dtype=input.dtype)[None, ...]
