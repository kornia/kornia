...
| Raw JSON | float16 | cuda, 1 | [base](quad_interp_results/half-base-cuda-t1-float16.json) | [optimized](quad_interp_results/half-opt-cuda-t1-float16.json) |
...
| Raw JSON | float16 | cpu, 1 | [base](quad_interp_results/half-base-cpu-t1-float16.json) | [optimized](quad_interp_results/half-opt-cpu-t1-float16.json) |
...
| Raw JSON | float16 | cpu, 14 | [base](quad_interp_results/half-base-cpu-t14-float16.json) | [optimized](quad_interp_results/half-opt-cpu-t14-float16.json) |
...
| Raw JSON | bfloat16 | cuda, 1 | [base](quad_interp_results/half-base-cuda-t1-bfloat16.json) | [optimized](quad_interp_results/half-opt-cuda-t1-bfloat16.json) |
...
| Raw JSON | bfloat16 | cpu, 1 | [base](quad_interp_results/half-base-cpu-t1-bfloat16.json) | [optimized](quad_interp_results/half-opt-cpu-t1-bfloat16.json) |
...
| Raw JSON | bfloat16 | cpu, 14 | [base](quad_interp_results/half-base-cpu-t14-bfloat16.json) | [optimized](quad_interp_results/half-opt-cpu-t14-bfloat16.json) |
