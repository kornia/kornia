...
def one_hot(labels: torch.Tensor, num_classes: int, device: torch.device=None, dtype: torch.dtype=None) -> torch.Tensor:
    r"""Converts an integer label tensor to a one-hot tensor.
