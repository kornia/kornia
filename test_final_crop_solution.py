...
def test_transformation_matrix_fix():
    ...
    test_points = torch.tensor(
        [
            [50.0, 50.0, 1.0],  # Center of original image
            [25.0, 25.0, 1.0],  # Quarter point
            [75.0, 75.0, 1.0],  # Three-quarter point
        ]
    )
    ...
    expected_center = torch.tensor([65.0, 65.0])
...
def test_bounding_box_alignment():
    ...
    original_bbox = torch.tensor([75.0, 75.0, 125.0, 125.0])  # 50x50 box
...
def demonstrate_before_after():
    ...
    # Test scenario
    original_point = torch.tensor([60.0, 60.0])
    padding_offset = 25.0
    crop_offset = 15.0
